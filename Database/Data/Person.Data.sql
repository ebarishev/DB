...
AS
	...
	USING (VALUES
		...
		, (258, N'Федор', 'Юрьевич', N'Попеленский')
		, (259, N'Андрей', 'Александрович', N'Ошемков')
		...
		, (531, N'Лидия', 'Ивановна', N'Головина') 
		...
		, (949, N'Эдгар', N'М.', 'Палмер')
		, (950, N'Ху', NULL, 'Сы-цзян')
		, (951, N'Р.', NULL, 'Уэллс')
		, (952, N'Е.', N'М.', 'Чирка')
		, (953, N'Б.', N'С.', 'Митягин')
		, (954, N'Майкл', NULL, N'Рид')
		, (955, N'А.', N'К.', 'Погребков')
		, (956, N'В.', N'Н.', N'Сушко') 
		, (957, N'М.', N'К.', N'Поливанов') 
		, (958, N'Н.', N'Н.', N'Боголюбов')
		, (959, N'Дж.', NULL, 'Брус')
		, (960, N'П.', NULL, 'Джиблин')
		, (961, N'И.', N'Г.', N'Щербак')
		, (962, N'Вильгельм', NULL, 'Клингенберг')
		, (963, N'А.', N'И.', 'Грюнталь')
		, (964, N'Виталий', N'Иванович', 'Сущанский')
		, (965, N'Г.', N'И.', 'Фалин')
		...
		, (983, N'Владимир', 'Маркович', N'Мануйлов')
		...
		, (1000, N'В.', N'В.', 'Толмачев')
		, (1001, N'Абрам', N'Иезекиилович', 'Плеснер')
		, (1002, N'И.', NULL, 'Гроссман')
		, (1003, N'Г.', N'М.', 'Цукерман')
		, (1004, N'В.', N'Е.', 'Тараканов')
		, (1005, N'Фредерик', NULL, 'Мостеллер')
		, (1006, N'Роберт', NULL, 'Рурке')
		, (1007, N'Джорж', NULL, 'Томас')
		, (1008, N'В.', N'В.', 'Фирсов')
		, (1009, N'Григорий', N'Аронович', 'Ястребинецкий')
		, (1010, N'В.', N'Н.', 'Руденко')
		, (1011, N'Е.', N'А.', 'Лодатко')
