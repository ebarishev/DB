...
AS
	...
	USING (VALUES
		...
		, (73, N'GSM', N'Graduate Studies in Mathematics')
		, (74, N'Учебники ВШЭ', N'Учебники ВШЭ')
		, (75, N'Летняя школа современная математика', N'Летняя школа "Современная математика"')
