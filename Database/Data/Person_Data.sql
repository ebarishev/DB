...
AS
	...
	USING (VALUES 
		...
		, (345, N'Борис', 'Иванович', N'Александров')
		, (346, N'Михаил', 'Владимирович', N'Лурье')
		, (347, N'Р.', 'Х.', N'Розов')
		, (348, N'Владимир', 'Григорьевич', N'Болтянский')
		, (349, N'Израиль', 'Цудикович', N'Гохберг')
		, (350, N'Игорь', 'Георгиевич', N'Журбенко')
		, (351, N'Ю.', 'В.', N'Прохоров')
		, (352, N'Ш.', NULL, N'Кобаяси')
		, (353, N'Л.', 'В.', N'Сабинин')
		, (354, N'Д.', 'О.', N'Шклярский')
		, (355, N'Г.', 'М.', N'Адельсон-Вельский')
		, (356, N'Н.', 'Н.', N'Ченцов')
		, (357, N'А.', 'М.', N'Яглом')
