...
AS
	...
	USING (
		...
		, ('E&SS', N'Под редакцией и с дополнениями')
		...
		, ('CM', N'Комментарии')
		, ('E&P&A', N'Под редакцией и с предисловием и добавлением')
		, ('RT', N'Сокращенный перевод')
		, ('WS', N'При участии')
		, ('SE', N'Научный редактор')
		, ('IL', N'Иллюстрации')
		, ('E&S', N'Под редакцией и с дополнением')
		, ('AL', N'Ведущий автор')
		, ('AGM', N'Руководитель авторской группы')
