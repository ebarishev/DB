...
AS
	...
	USING (
		VALUES
			...
			, (1, 842, 1, '978-5-4439-1467-1', NULL)
			, (1, 843, 1, '0-8218-3227-1', N'англ.'), (1, 843, 2, '5-94057-126-3', NULL)
			, (1, 844, 1, '978-5-4439-1465-7', NULL)
			, (1, 845, 1, '978-5-4439-4045-8', NULL)
			, (1, 846, 1, '978-5-94057-298-5', NULL)
			, (2, 847, 1, '', NULL)
			, (46, 848, 1, '978-5-9710-6387-2', NULL)
			...
			, (2, 866, 1, '', NULL)
			, (2, 867, 1, '', NULL)
			, (16, 868, 1, '5-93972-068-4', NULL)
			, (5, 869, 1, '', NULL)
			, (18, 870, 1, '', NULL)
			, (2, 871, 1, '', NULL)
			, (61, 872, 1, '5-354-00670-8', NULL)
			, (1, 873, 1, '978-5-4439-0207-4', NULL)
			, (2, 874, 1, '5-03-001424-1', N'русск.'), (2, 874, 2, '0-387-96426-6', N'англ.')
			, (1, 875, 1, '0-387-94126-6', N'англ.'), (1, 875, 2, '5-94057-086-0', NULL)
			, (5, 876, 1, '', NULL)
			, (2, 877, 1, '', NULL)
			, (5, 878, 1, '', NULL)
			, (18, 879, 1, '', NULL)
			...
			, (18, 888, 1, '', NULL)
			, (5, 889, 1, '', NULL)
			, (2, 890, 1, '5-03-001002-5', N'русск.'), (2, 890, '0-8176-3329-4', N'англ.')
			, (5, 891, 1, '5-02-013909-2', NULL)
			, (2, 892, 1, '', NULL)
			, (2, 893, 1, '', NULL)
			, (5, 894, 1, '', NULL)
			, (5, 895, 1, '', NULL)
			, (5, 896, 1, '', NULL)
			, (2, 897, 1, '5-03-002484-0', N'русск.'), (2, 897, '0-8218-5073-3', N'англ.')
			, (16, 898, 1, '5-93972-103-6', NULL)
			, (18, 899, 1, '', NULL)
			, (2, 900, 1, '', NULL)
